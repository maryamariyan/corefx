...
namespace System.ComponentModel.Composition.Factories
{
    partial class ExportProviderFactory
    {
        public class RecomposableExportProvider : ExportProvider
        {
            ...
            {
                using (var transaction = new AtomicComposition())
                {
                    transaction.AddCompleteAction(() => this._exports = newExports);
                    transaction.SetValue(this, newExports);
                    ...
                    this.OnExportsChanging(new ExportsChangeEventArgs(addedExports, removedExports, transaction));

                    transaction.AddCompleteAction(() => this.OnExportsChanged(
